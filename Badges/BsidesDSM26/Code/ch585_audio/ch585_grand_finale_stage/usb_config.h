...
#define FUSB_EP1_MODE         1  // TX (IN to host)
#define FUSB_EP2_MODE         -1 // RX (OUT from host)
#define USB_EP_TX             1
#define USB_EP_RX             2
...
#define FUSB_STR_PRODUCT      u"NFCA"
...
static const uint8_t config_descriptor[ ] =
{
    ...
    0x02,                                                   // bmAttributes (0x02: Bulk, 0x03: Interrupt)
    0x40, 0x00,                                             // wMaxPacketSize (64 bytes for full-speed)
